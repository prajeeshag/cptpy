...
fig.suptitle(f"MME Skill Scores — {var}, Forecast Month - {month}", fontsize=14, fontweight="bold")
...
plt.savefig(f"MME_skill_scores_{var}_{month}_panels.png", dpi=150, bbox_inches="tight")
plt.close()
print("Saved.")